...
PATH_GENERATE_MIDIFILE = '../Outputs/output.mid'  # 生成的midi文件所在路径
...
FLAG_TRAINING = False  # 是否处于训练状态 为True则训练 为False则直接使用现成数据生成音乐

# 传入到程序中的参数
PROGRAM_ARGS = [
    {'name': 'outputpath', 'type': str, 'default': PATH_GENERATE_MIDIFILE},
    {'name': 'diaryId', 'type': int, 'default': -1},
    {'name': 'MelodyMethod', 'type': str, 'default': 'short'}
]
